  ...
  <table border="1">
    ...
    ?>
      <tr>
        ...
        <td><a href="m_hapus_pelanggan.php?id_pelanggan=<?= $pelanggan['id_pelanggan'] ?>">Hapus</a></td>
        <td><a href="v_detail_penjualan.php?id_pelanggan=<?= $pelanggan['id_pelanggan'] ?>">Beli</a></td>
      </tr>
    <?php } ?>
  </table>
